...
public class Evaluate {
    public static void main(String[] args) { 
		...
		String s = "";
		in = new Scanner(calculation);
        while (in.hasNext() || notFinished == false) {
			if (notFinished == true) s = in.next();
            if      (s.equals("("))               ;
                ...
                vals.push(v);
				if (ops.isEmpty()) notFinished = true;
				}
            }
            else {
				vals.push(Double.parseDouble(s));
				if (!in.hasNext()) {notFinished = false;}
			}
        }
